# Invocation
#./configure_project.sh MODULE="coolproject" REGISTRY="docker.pkg.github.com/gwright99/repo-name"
for ARGUMENT in "$@"
do
...
DUMMY_REGISTRY='docker.pkg.github.com/gwright99/python-project-blueprint'
BLUE='\033[1;34m'
NC='\033[0m' # No Color
